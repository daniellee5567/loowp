		...
		<div class="container">
			...
			<?php if ( _cao( 'cao_copyright_text', '' ) != '' ) : ?>
			  <div class="site-info">
			    ...
			    <a href="https://beian.miit.gov.cn" target="_blank" class="text" rel="external nofollow noopener noreferrer"> <?php echo _cao('cao_ipc_info')?><br></a>
			    <?php endif; ?>
			  </div>
			<?php endif; ?>
		</div>
...
<div class="rollbar">
    ...
    <div class="rollbar-item tap-qq" etap="tap-qq"><a target="_blank" title="QQ咨询" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo _cao('site_kefu_qq');?>&site=qq&menu=yes" rel="external nofollow noopener noreferrer"><i class="fa fa-qq"></i></a></div>
    <?php endif; ?>
...
<script>
    console.log("\n %c <?php echo _the_theme_name().' V'._the_theme_version();?> %c https://vip.ylit.cc \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;");
