...
<div class="col-xs-12 col-sm-12 col-md-9">
    ...
    <form class="mb-0">
                        ...
                        <div class="col-md-12">
                            <div class="charge">
                                ...
                                <div class="modules__content">
                                    <?php if (_cao('is_alipay') || _cao('is_weixinpay') || _cao('is_payjs') || _cao('is_xunhupay') || _cao('is_xunhualipay') || _cao('is_xunhupay_ali') ||_cao('is_xunhupay_wx') ||_cao('is_codepay') ||_cao('is_paypy')||_cao('is_yzf')) : $cdk_display = 'style="display: none;"';?>
                                    <div id="yuecz">
        ...
        <!-- 付款选项 -->
        <?php if (_cao('is_alipay') || _cao('is_weixinpay') || _cao('is_payjs') || _cao('is_xunhupay') || _cao('is_xunhualipay') || _cao('is_xunhupay_wx') || _cao('is_xunhupay_ali') || _cao('is_codepay')||_cao('is_paypy')||_cao('is_yzf')) : ?>
        <div class="form-box">
            ...
            <div class="row">
				...
				<?php if (_cao('is_paypy')) : $paypy = _cao('paypy'); ?>
                                <?php if (!$paypy['hide_wxpay']) : ?>
                                    <div style=" margin-right: 20px; ">
                                        <span class="flex-center payradio">
                                              <input type="radio" id="pay_paypywx" name="pay_type" value="21">
                                              <label class="" for="pay_paypywx">
                                                <img src="<?php echo get_template_directory_uri() . '/assets/icons/weixin.png';?>" height="35" class="mr-2">
                                              </label>
                                        </span>
                                    </div>
                                ...
                                <?php if (!$paypy['hide_alipay']) : ?>
                                    <div style=" margin-right: 20px; ">
                                        <span class="flex-center payradio">
                                              <input type="radio" id="pay_paypyali" name="pay_type" value="20">
                                              <label class="" for="pay_paypyali">
                                                <img src="<?php echo get_template_directory_uri() . '/assets/icons/alipay.png';?>" height="35" class="mr-2">
                                              </label>
                                        </span>
                                    </div>
                            ...
                            <?php endif; ?>   
			    <?php if (_cao('is_yzf')) : $yzf = _cao('yzf'); ?>
                                <?php if ($yzf['is_yzf_wx']) :?>
                                    <div style=" margin-right: 20px; ">
                                        <span class="flex-center payradio">
                                              <input type="radio" id="pay_yzf_wx" name="pay_type" value="12">
                                              <label class="" for="pay_yzf_wx">
                                                <img src="<?php echo get_template_directory_uri() . '/assets/icons/weixin.png';?>" height="35" class="mr-2">
                                              </label>
                                        </span>
                                    </div>
                                    <?php endif; ?>
                                <?php if ($yzf['is_yzf_ali']) :?>
                                    <div style=" margin-right: 20px; ">
                                        <span class="flex-center payradio">
                                              <input type="radio" id="pay_yzf_ali" name="pay_type" value="11">
                                              <label class="" for="pay_yzf_ali">
                                                <img src="<?php echo get_template_directory_uri() . '/assets/icons/alipay.png';?>" height="35" class="mr-2">
                                              </label>
                                        </span>
                                    </div>
