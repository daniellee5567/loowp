...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'    => 'text',
            'title'   => 'Twitter站点用户名',
            'desc'    => '输入您的Twitter用户名（不需要@符号），用于Twitter卡片显示',
            'default' => '',
            'attributes' => array(
        ...
        array(
            ...
            'title'   => '邀请卡购买网址',
            'label'   => '邀请卡购买网址',
            'default' =>  'https://611qk.com/details/718AEF85',
        ), 
        array(
        ...
        array(
            ...
            'type'    => 'switcher',
            'title'   => '全站底部公告开关',
            'label'   => '开启后将在页面底部显示公告内容',
            'default' => true,
        ),    	
        array(
            'id'         => 'site_notify_fixed',
            'type'       => 'textarea',
            'title'      => '全站底部公告-内容',
            'desc'       => '全站底部固定公告，通知，纯文本通知弹窗',
            'attributes' => array(
                'style' => 'width: 100%;',
            ),
            'default'    => '这是一条网站公告，可在后台开启或关闭，可自定义背景颜色，标题，内容，用户首次打开关闭后不再重复弹出，此处可使用html标签...',
...
CSF::createSection($prefix, array(
    ...
    'fields'      => array(
        ...
        array(
            ...
            'default'        => array(
                'enabled'  => array(
					'zhankr-shy-1' => '三合一幻灯片模块',
					'census' => '网站统计模块',
					'zhankr-cms-2' => 'CMS模块-风格2',
                    'lastpost' => '最新文章模块',
                    'catpost' => '分类CMS文章展模块',
    			'tagpost'=> '标签CMS文章展示模块',
                    'ulist'   => '纯标题文章模块',
                ...
                'disabled' => array(
                    'search'  => '搜索条模块',
                    'slider'  => '幻灯片模块',
					'zhankr-hdp-1' => '全屏动态幻灯片模块',
                    'vip'     => '会员介绍模块',
					'zhankr-cms-1' => 'CMS模块-风格1',
                    'gridpost'  => '网格文章展示模块',
                    'catbox'  => '分类滑块模块-风格1',
                    'catbox2' => '分类滑块模块-风格2',
					'ulist1'   => '纯标题文章模块2',
        ...
        array(
            ...
            'fields' => array(
               ...
               array(
                    'id'          => 'posts_4_tag',
                    'type'        => 'text',
                    'title'       => '4小图所属标签别名列表（标签下必须有文章）',
            		'desc' => '选择一个标签slug列表，逗号分隔，如果为空则选择从分类里面选取',
                ),
                array(
                    'id'          => 'posts_4',
                    'type'        => 'select',
                ...
                array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            'id'          => 'tag',
                            'type'        => 'text',
                            'title'       => '推荐的标签，用英文逗号分隔（标签下必须有文章）',
                            'placeholder' => '用英文逗号分隔多个标签别名(slug)'
                        ),
                        array(
                            'id'          => 'wholename',
                            'type'        => 'text',
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'fields'     => array(
                array(
                    'type'    => 'notice',
                    'style'   => 'success',
                    'content' => '虎皮V3  <a target="_blank" href="https://admin.xunhupay.com/sign-up/4123.html">注册地址</a><br/>如测试可使用测试APPID和密钥进行。但只支持0.1元付款测试<br/>',
                ),
                array(
                    'id'      => 'is_pop_qrcode',
                    'type'    => 'switcher',
        ...
        array(
            ...
            'dependency' => array('is_paypy', '==', 'true'),
        ),
  ...
  <br/>------授权错误会提示错误消息，成功则顶部显示-设置已保存。</br></br><i class="fa fa-heart" style=" color: red; "></i> PS：承蒙您对本主题的喜爱，我们愿向小三一样，做大哥的女人，做大哥网站中最想日的一个。开发者不易，我们真诚的希望和感谢每一个真心建站运营的朋友能支持日系列的正版主题，更好的更用心的等你来调教。如此强大好用的日系列主题，包含支付等重要安全功能，我们希望用户一定要重视自己的数据安全，不要相信所谓破解等盗版，盗版无利不起早，一切以安全为己任。共同维护创造国内健康的WordPress使用环境。开发者油条敬上。</br></br><b><font color="red">授权注意事项：</font></b>中途更换域名，更换HTTPS，更换网站标题等，都需要后台主题设置重新保存一下设置和授权，请修正数据库中的域名，保证你绑定的域名和你WP后台，常规设置里面的域名一致。其次，中途从不同版本的数据库SQL操作迁移数据库，导入导出都会促使编码格式不对，个例情况，如果有个别弹出授权提示，请检查授权信息不要有空格，重新填写正确的授权保存即可，数据无损。如果都没有问题请检查自己网站根目录所有wordpress文件的权限是否标准的755和拥有者一致，个别网站权限错乱修复后重新保存授权即可！',
    'fields'      => array(
        ...
        array(
            ...
            'type'  => 'text',
            'title' => '会员ID',
            'after' => '<p><b><font color="red">注意不要有空格 </font></b>会员购买授权中心 <a href="https://vip.ylit.cc/" target="_blank"> RI-VIP官网</a></p>',
