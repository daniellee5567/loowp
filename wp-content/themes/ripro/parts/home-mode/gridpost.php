...
if(true){	
  ...
  if(!empty($mode_gridpost['posts_4_tag'])){
    $posts_4 = array(
    'tag'       => $mode_gridpost['posts_4_tag'],
...
<div class="section bgcolor-fff " data-bg="<?php echo esc_url( $mode_gridpost['bgimg'] ); ?>">
  <div class="container">
    <div class="module gridpost row">
      ...
      <div class="col-12 col-md-6 sm-flex padding-10">
        ...
        <div class="list-item list-homegrid-overlay flex-fill">
            <div class="media media-28x15 sm-flex flex-fill" fetchpriority="high">
                <a<?php echo _target_blank();?> class="media-content " href="<?php echo esc_url( get_the_permalink() ); ?>" data-bg="<?php echo _get_post_thumbnail_url(); ?>" style="background-image: url(<?php echo _get_post_thumbnail_url(); ?>);">
